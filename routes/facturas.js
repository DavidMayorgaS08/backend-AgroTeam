...
router.put("/:id", [
    ...
    check("detalle.*.id_producto", "El id del producto es obligatorio").not().isEmpty(),
    check("detalle.*.id_producto", "El id del producto no es válido").isMongoId(),
    check("detalle.*.id_producto").custom(facturasHelper.validarIdProducto),
