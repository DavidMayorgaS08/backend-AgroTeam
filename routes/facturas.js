...
router.put("/:id", [
    ...
    check("detalle.*.id_insumo", "El id del insumo es obligatorio").not().isEmpty(),
    check("detalle.*.id_insumo", "El id del insumo no es válido").isMongoId(),
    check("detalle.*.id_insumo").custom(facturasHelper.validarIdInsumo),
